...
//       // console.log(rows);
//       const data = rows.slice(2, rows.length);
...
//           const filename = `files/executive/${uuidv4()}_${file.name}`;
...
//         }
//         // id 변경할것
//         EXECUTIVE.doc('07동호회').collection('userList').add(obj)
//         // console.log("DOC>DATA", counter.data());
        
//       };
//       // counter 변경할것
//       COUNTER.doc('counter').update({ executive07: parseInt(counter.data().executive07) + datas.length });
//       // console.log("finish");
