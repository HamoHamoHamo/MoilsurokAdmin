...
export default function DatasProfile() {
  ...
  useEffect(() => {
    ...
    // a.map(() => {PROFILE.add({pubDate: "2022-05-21 10:11", modifiedDate: "2022-02-11 10:10", year: "기수", name: "이름", birthdate: "20220505", phoneNum: "01012341234", email: "test@naver.com", company: "킹버스", department: "제품개발부서", comPosition: "직위", comTel: "022332323", comAdr: "수원시 매송고색로", faxNum: "1234213", sector: "it", check: "O"}) });
    let list = []
    let id = []
